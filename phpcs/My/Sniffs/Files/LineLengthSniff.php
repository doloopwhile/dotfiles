 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class My_Sniffs_Files_LineLengthSniff implements PHP_CodeSniffer_Sniff
{
    ...
    protected function checkLineLength(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $lineContent)
    {
        ...
        if (PHP_CODESNIFFER_ENCODING !== 'iso-8859-1') {
            ...
            $lineLength = mb_strwidth($lineContent, PHP_CODESNIFFER_ENCODING);
            if ($lineLength === false) {
        ...
        if ($this->absoluteLineLimit > 0
            ...
            $error = 'Line exceeds maximum limit of %s width; it has %s width';
            ...
            $warning = 'Line exceeds %s width; it has %s width';
